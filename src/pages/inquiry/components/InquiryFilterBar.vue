<template>
  <view class="filter-container">
    <view class="filter-head">
      ...
      <view v-if="sideOpen" class="side-dropdown">
        <view
          v-for="(s, i) in sideOptions"
          :key="s"
          :class="['side-dropdown-item', activeSide === i && 'side-dropdown-item_active']"
          @click="selectSide(i)"
        >
          {{ s }}
        </view>
      ...
      <view v-if="categoryOpen" class="category-panel">
        <view class="category-grid">
          <view
            ...
            :key="c"
            :class="['category-pill', activeCategory === i && 'category-pill_active']"
